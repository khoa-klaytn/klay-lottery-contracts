...
contract SSLottery is IndexedSSLottery {
    ...
    ) IndexedSSLottery(_randomGeneratorAddress, _dataFeedConsumerAddress, _minTicketPriceInUsd) {}
    ...
    function changeRandomGenerator(address _randomGeneratorAddress) external onlyOwner {
        ...
        IVRFConsumer(_randomGeneratorAddress).requestRandomNumberDirect();

        // Calculate the finalNumber based on the randomResult generated by ChainLink's fallback
        IVRFConsumer(_randomGeneratorAddress).randomResult();
